...
class TestAuth(unittest.TestCase):
    ...
    def test_authorization_and_verification(self):
        ...
        payload = authorize(current_time + 300, self.signer.address, HexBytes(self.signer.private_key))
    ...
    def test_authorization_and_verification_fails_after_deadline(self):
        current_time = int(time.time())
        payload = authorize(current_time - 1, self.signer.address, HexBytes(self.signer.private_key))
