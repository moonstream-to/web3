...
ETHEREUM_PROVIDER_URI = os.environ.get("MOONSTREAM_PROVIDER_URI_ETHEREUM")
MUMBAI_PROVIDER_URI = os.environ.get("MOONSTREAM_PROVIDER_URI_MUMBAI")
POLYGON_PROVIDER_URI = os.environ.get("MOONSTREAM_PROVIDER_URI_POLYGON")
XDAI_PROVIDER_URI = os.environ.get("MOONSTREAM_PROVIDER_URI_XDAI")

NODEBALANCER_ACCESS_ID = os.environ.get("MOONSTREAM_ENGINE_NODEBALANCER_ACCESS_ID")
