...
class EeseeHero:
    def __init__(self, contract_address: Optional[ChecksumAddress]):
        self.contract_name = "EeseeHero"
        self.address = contract_address
        self.contract = None
        self.abi = get_abi_json("EeseeHero")
    ...
    def deploy(
        ...
        _metadata_base_uri: str,
        transaction_config,
    ):
        contract_class = contract_from_build(self.contract_name)
        deployed_contract = contract_class.deploy(
            terminus_address, terminus_pool_id, _metadata_base_uri, transaction_config
        )
    ...
    def admin_terminus_address(
        self, block_number: Optional[Union[str, int]] = "latest"
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.adminTerminusAddress.call(block_identifier=block_number)

    def admin_terminus_pool_id(
        self, block_number: Optional[Union[str, int]] = "latest"
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.adminTerminusPoolID.call(block_identifier=block_number)
    ...
    def is_admin(
        ...
        self.assert_contract_is_instantiated()
        return self.contract.isAdmin.call(account, block_identifier=block_number)
    ...
    def metadata_base_uri(
        self, block_number: Optional[Union[str, int]] = "latest"
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.metadataBaseURI.call(block_identifier=block_number)

    def mint(self, to: ChecksumAddress, quantity: int, transaction_config) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.mint(to, quantity, transaction_config)
    ...
    def safe_mint(
        self, to: ChecksumAddress, quantity: int, _data: bytes, transaction_config
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.safeMint(to, quantity, _data, transaction_config)
    ...
    def set_base_uri(self, new_uri: str, transaction_config) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.setBaseURI(new_uri, transaction_config)
...
def handle_verify_contract(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = EeseeHero(args.address)
    result = contract.verify_contract()
    print(result)


def handle_admin_terminus_address(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = EeseeHero(args.address)
    result = contract.admin_terminus_address(block_number=args.block_number)
    print(result)


def handle_admin_terminus_pool_id(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = EeseeHero(args.address)
    result = contract.admin_terminus_pool_id(block_number=args.block_number)
    print(result)
...
def handle_is_admin(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = EeseeHero(args.address)
    result = contract.is_admin(account=args.account, block_number=args.block_number)
    print(result)
...
def handle_metadata_base_uri(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = EeseeHero(args.address)
    result = contract.metadata_base_uri(block_number=args.block_number)
    print(result)
...
def handle_mint(args: argparse.Namespace) -> None:
    ...
    result = contract.mint(
        to=args.to, quantity=args.quantity, transaction_config=transaction_config
    )
    print(result)
    if args.verbose:
        print(result.info())
...
def handle_safe_mint(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = EeseeHero(args.address)
    transaction_config = get_transaction_config(args)
    result = contract.safe_mint(
        to=args.to,
...
def handle_set_base_uri(args: argparse.Namespace) -> None:
    ...
    result = contract.set_base_uri(
        new_uri=args.new_uri, transaction_config=transaction_config
    )
    print(result)
    if args.verbose:
        print(result.info())
...
def generate_cli() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="CLI for EeseeHero")
    ...
    deploy_parser.add_argument(
        "--metadata-base-uri-arg", required=True, help="Type: string", type=str
    )
    ...
    admin_terminus_address_parser = subcommands.add_parser("admin-terminus-address")
    add_default_arguments(admin_terminus_address_parser, False)
    admin_terminus_address_parser.set_defaults(func=handle_admin_terminus_address)

    admin_terminus_pool_id_parser = subcommands.add_parser("admin-terminus-pool-id")
    add_default_arguments(admin_terminus_pool_id_parser, False)
    admin_terminus_pool_id_parser.set_defaults(func=handle_admin_terminus_pool_id)
    ...
    is_admin_parser = subcommands.add_parser("is-admin")
    add_default_arguments(is_admin_parser, False)
    is_admin_parser.add_argument("--account", required=True, help="Type: address")
    is_admin_parser.set_defaults(func=handle_is_admin)
    ...
    metadata_base_uri_parser = subcommands.add_parser("metadata-base-uri")
    add_default_arguments(metadata_base_uri_parser, False)
    metadata_base_uri_parser.set_defaults(func=handle_metadata_base_uri)
    ...
    safe_mint_parser = subcommands.add_parser("safe-mint")
    add_default_arguments(safe_mint_parser, True)
    safe_mint_parser.add_argument("--to", required=True, help="Type: address")
    safe_mint_parser.add_argument(
        "--quantity", required=True, help="Type: uint256", type=int
    )
    safe_mint_parser.add_argument(
        "--data-arg", required=True, help="Type: bytes", type=bytes_argument_type
    )
    safe_mint_parser.set_defaults(func=handle_safe_mint)
    ...
    set_base_uri_parser.add_argument(
        "--new-uri", required=True, help="Type: string", type=str
    )
