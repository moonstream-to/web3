...
def list_registered_contracts(
    ...
    """
    query = db_session.query(RegisteredContract).limit(limit).offset(offset)
...
def lookup_registered_contracts(
    ...
    """
    query = db_session.query(RegisteredContract)
...
def delete_registered_contract(
    db_session: Session, registered_contract_id: uuid.UUID
) -> RegisteredContract:
    """
...
def render_registered_contract(contract: RegisteredContract) -> Dict[str, Any]:
    return {
        "id": str(contract.id),
