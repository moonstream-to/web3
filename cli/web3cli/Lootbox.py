...
class Lootbox:
    ...
    def deploy(
        ...
        _administrator_terminus_address: ChecksumAddress,
        ...
        deployed_contract = contract_class.deploy(
            _terminus_address,
            _administrator_terminus_address,
    ...
    def active_lootbox_openings(
        self, arg1: bytes, block_number: Optional[Union[str, int]] = "latest"
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.ActiveLootboxOpenings.call(
            arg1, block_identifier=block_number
        )

    def current_openingfor_user(
        self, arg1: ChecksumAddress, block_number: Optional[Union[str, int]] = "latest"
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.CurrentOpeningforUser.call(
            arg1, block_identifier=block_number
        )

    def erc1155_reward_type(
        self, block_number: Optional[Union[str, int]] = "latest"
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.ERC1155_REWARD_TYPE.call(block_identifier=block_number)

    def erc20_reward_type(
        self, block_number: Optional[Union[str, int]] = "latest"
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.ERC20_REWARD_TYPE.call(block_identifier=block_number)

    def ordinary_lootbox_type(
        self, block_number: Optional[Union[str, int]] = "latest"
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.ORDINARY_LOOTBOX_TYPE.call(block_identifier=block_number)

    def random_lootbox_type_1(
        self, block_number: Optional[Union[str, int]] = "latest"
    ) -> Any:
        self.assert_contract_is_instantiated()
    ...
    def administrator_pool_id(
        self, block_number: Optional[Union[str, int]] = "latest"
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.administratorPoolId.call(block_identifier=block_number)

    def administrator_terminus_address(
        self, block_number: Optional[Union[str, int]] = "latest"
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.administratorTerminusAddress.call(
            block_identifier=block_number
        )
    ...
    def get_chainlink_vrf_fee(
        self, block_number: Optional[Union[str, int]] = "latest"
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.getChainlinkVRFFee.call(block_identifier=block_number)

    def get_chainlink_vrf_keyhash(
        self, block_number: Optional[Union[str, int]] = "latest"
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.getChainlinkVRFKeyhash.call(block_identifier=block_number)

    def get_lootbox_balance(
        self,
        lootbox_id: int,
        ...
        self.assert_contract_is_instantiated()
        return self.contract.getLootboxBalance.call(
            lootbox_id, owner, block_identifier=block_number
        )

    def get_lootbox_item_by_index(
        self,
        lootbox_id: int,
        item_index: int,
        block_number: Optional[Union[str, int]] = "latest",
        ...
        self.assert_contract_is_instantiated()
        return self.contract.getLootboxItemByIndex.call(
            lootbox_id, item_index, block_identifier=block_number
        )

    def get_lootbox_uri(
        self, lootbox_id: int, block_number: Optional[Union[str, int]] = "latest"
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.getLootboxURI.call(
            lootbox_id, block_identifier=block_number
        )
    ...
    def lootbox_idby_terminus_pool_id(
        self, arg1: int, block_number: Optional[Union[str, int]] = "latest"
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.lootboxIdbyTerminusPoolId.call(
            arg1, block_identifier=block_number
        )

    def lootbox_item_count(
        self, lootbox_id: int, block_number: Optional[Union[str, int]] = "latest"
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.lootboxItemCount.call(
            lootbox_id, block_identifier=block_number
        )

    def lootbox_typeby_lootbox_id(
        self, arg1: int, block_number: Optional[Union[str, int]] = "latest"
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.lootboxTypebyLootboxId.call(
            arg1, block_identifier=block_number
        )
    ...
    def terminus_address(
        self, block_number: Optional[Union[str, int]] = "latest"
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.terminusAddress.call(block_identifier=block_number)

    def terminus_pool_idby_lootbox_id(
        self, arg1: int, block_number: Optional[Union[str, int]] = "latest"
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.terminusPoolIdbyLootboxId.call(
            arg1, block_identifier=block_number
        )

    def total_lootbox_count(
        self, block_number: Optional[Union[str, int]] = "latest"
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.totalLootboxCount.call(block_identifier=block_number)
...
def handle_deploy(args: argparse.Namespace) -> None:
    ...
    result = contract.deploy(
        ...
        _administrator_terminus_address=args.administrator_terminus_address_arg,
...
def handle_active_lootbox_openings(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = Lootbox(args.address)
    result = contract.active_lootbox_openings(
...
def handle_current_openingfor_user(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = Lootbox(args.address)
    result = contract.current_openingfor_user(
        arg1=args.arg1, block_number=args.block_number
    )
    print(result)
...
def handle_erc1155_reward_type(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = Lootbox(args.address)
    result = contract.erc1155_reward_type(block_number=args.block_number)
    print(result)
...
def handle_erc20_reward_type(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = Lootbox(args.address)
    result = contract.erc20_reward_type(block_number=args.block_number)
    print(result)
...
def handle_ordinary_lootbox_type(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = Lootbox(args.address)
    result = contract.ordinary_lootbox_type(block_number=args.block_number)
    print(result)
...
def handle_administrator_pool_id(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = Lootbox(args.address)
    result = contract.administrator_pool_id(block_number=args.block_number)
    print(result)


def handle_administrator_terminus_address(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = Lootbox(args.address)
    result = contract.administrator_terminus_address(block_number=args.block_number)
    print(result)
...
def handle_get_chainlink_vrf_fee(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = Lootbox(args.address)
    result = contract.get_chainlink_vrf_fee(block_number=args.block_number)
    print(result)
...
def handle_get_chainlink_vrf_keyhash(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = Lootbox(args.address)
    result = contract.get_chainlink_vrf_keyhash(block_number=args.block_number)
    print(result)
...
def handle_get_lootbox_balance(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = Lootbox(args.address)
    result = contract.get_lootbox_balance(
        lootbox_id=args.lootbox_id, owner=args.owner, block_number=args.block_number
    )
    print(result)
...
def handle_get_lootbox_uri(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = Lootbox(args.address)
    result = contract.get_lootbox_uri(
        lootbox_id=args.lootbox_id, block_number=args.block_number
    )
    print(result)
...
def handle_lootbox_idby_terminus_pool_id(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = Lootbox(args.address)
    result = contract.lootbox_idby_terminus_pool_id(
        arg1=args.arg1, block_number=args.block_number
    )
    print(result)
...
def handle_lootbox_item_count(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = Lootbox(args.address)
    result = contract.lootbox_item_count(
        lootbox_id=args.lootbox_id, block_number=args.block_number
    )
    print(result)
...
def handle_lootbox_typeby_lootbox_id(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = Lootbox(args.address)
    result = contract.lootbox_typeby_lootbox_id(
        arg1=args.arg1, block_number=args.block_number
    )
    print(result)
...
def handle_terminus_address(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = Lootbox(args.address)
    result = contract.terminus_address(block_number=args.block_number)
    print(result)
...
def handle_terminus_pool_idby_lootbox_id(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = Lootbox(args.address)
    result = contract.terminus_pool_idby_lootbox_id(
        arg1=args.arg1, block_number=args.block_number
    )
    print(result)
...
def handle_total_lootbox_count(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = Lootbox(args.address)
    result = contract.total_lootbox_count(block_number=args.block_number)
    print(result)
...
def generate_cli() -> argparse.ArgumentParser:
    ...
    deploy_parser.add_argument(
        "--administrator-terminus-address-arg", required=True, help="Type: address"
    )
    deploy_parser.add_argument(
    ...
    add_lootbox_item_parser.add_argument(
        "--item", required=True, help="Type: tuple", type=eval
    )
    ...
    administrator_terminus_address_parser = subcommands.add_parser(
        "administrator-terminus-address"
    )
    add_default_arguments(administrator_terminus_address_parser, False)
    administrator_terminus_address_parser.set_defaults(
        func=handle_administrator_terminus_address
    )
