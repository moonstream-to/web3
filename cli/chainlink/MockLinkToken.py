...
class MockLinkToken:
    def __init__(self, contract_address: Optional[ChecksumAddress]):
        self.contract_name = "MockLinkToken"
        self.address = contract_address
        self.contract = None
        self.abi = get_abi_json("MockLinkToken")
    ...
    def transfer_and_call(
        self, _to: ChecksumAddress, _value: int, _data: bytes, transaction_config
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.transferAndCall(_to, _value, _data, transaction_config)
...
def handle_verify_contract(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = MockLinkToken(args.address)
...
def generate_cli() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="CLI for MockLinkToken")
    ...
    transfer_and_call_parser.add_argument(
        "--value-arg", required=True, help="Type: uint256", type=int
    )
    transfer_and_call_parser.add_argument(
