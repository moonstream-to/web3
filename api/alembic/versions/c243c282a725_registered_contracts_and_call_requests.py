...
Revision ID: c243c282a725
Revises: 782ac8fe23c8
Create Date: 2023-04-05 06:09:08.627286
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("requester", sa.VARCHAR(length=256), nullable=False),
    ...
    op.create_index(
        op.f("ix_call_requests_requester"), "call_requests", ["requester"], unique=False
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f("ix_call_requests_requester"), table_name="call_requests")
