...
import { SessionMetadata, StageMetadata, PathMetadata} from "./GoFPTypes";
    ...
    stages: [
      ...
      },
      {
        ...
        paths: [
          {
            lore: "",
            imageUrl: "https://media.gettyimages.com/id/683732297/photo/storm-vehicle-with-the-center-for-severe-weather-research-driving-into-the-path-of-tornado.jpg?s=1024x1024&w=gi&k=20&c=aiGZkG7T_J9es9a1eTGyKr-ke2HesoPfuWHRO8OPJJM="
          },
          {
            lore: "",
  ...
  return (
    ...
    >
      ...
      <HStack my="10" alignItems="top">
        <SessionPanel sessionMetadata={sessionData} />
      </HStack>
    </Box>
  );
};
