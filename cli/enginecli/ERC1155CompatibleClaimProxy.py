...
class ERC1155CompatibleClaimProxy:
    def __init__(self, contract_address: Optional[ChecksumAddress]):
        self.contract_name = "ERC1155CompatibleClaimProxy"
        self.address = contract_address
        self.contract = None
        self.abi = get_abi_json("ERC1155CompatibleClaimProxy")
    ...
    def on_erc1155_received(
        ...
        return self.contract.onERC1155Received(
            operator, from_, token_id, amount, data, transaction_config
        )
...
def handle_deploy(args: argparse.Namespace) -> None:
    ...
    contract = ERC1155CompatibleClaimProxy(None)
...
def handle_verify_contract(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = ERC1155CompatibleClaimProxy(args.address)
...
def generate_cli() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="CLI for ERC1155CompatibleClaimProxy")
